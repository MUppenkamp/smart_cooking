...
// const createRecipeIngredientTable = 'CREATE TABLE IF NOT EXISTS recipe_ingredient (id serial primary key, recipe_id integer references recipe(id), name varchar, quantity decimal, quantity_unit_id integer references quantity_unit(id))';
